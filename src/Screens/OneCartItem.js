...
import { removeFromCart, selectedProduct } from "../redux/Actions/Actions";
...
const OneCartProduct = () => {
    ...
    return (
        <div className="product">
            <div>
                <Link to={`/cart`} className="back btn btn-primary">
                    Back
                </Link>
            </div>
            <br />
                    ...
                    <div className="row g-0 justify-content-around">
                        ...
                        <div className="col-md-6 detail">
                            <div className="card-body">
                                ...
                                <br />
                                <br />
                                <button className="btn btn-primary" onClick={() => { dispatch(removeFromCart(id)) }} >
                                    Remove From Cart
                                </button>
                            </div>
                        </div>
